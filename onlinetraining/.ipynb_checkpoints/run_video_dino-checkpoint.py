...
frame_interval = 1
frame_no = 5
video_data = 'resample_5_frames_dinov3_embeddings.pt'
max_seq_len_list = [10]
...
'''
video_model_load = 'dinov3' # mvit-base-32x3 slowfast-50 slowfast16x8-101
video_freeze_paras_before = 152# 326 270 576
batch_size_list = [60] # 30 120 120
user_model_load = 'sasrec'
CVA_depth = 16
...
# exp_name = f"{user_model_load}_{video_model_load}-resamplePerceiverNoAttention_Ablation"
exp_name = f"{user_model_load}_{video_model_load}-resampleCVA_Depth_{CVA_depth}"
        ...
        for max_seq_len in max_seq_len_list:
            for index in index_list:
                ...
                run_py = "CUDA_VISIBLE_DEVICES='0,1,2,3' \
                        ...
                        --nproc_per_node 4 --master_port 29700 main_dino.py \
                        --exp_name {} --root_data_dir {} --root_model_dir {} --dataset {} --behaviors {} --text_data {}  --image_data {} --video_data {} --model {} --CVA_M {}\
                        ...
                        --version {}".format(
                        exp_name, root_data_dir, root_model_dir, dataset, behaviors, text_data, image_data, video_data, user_model_load, CVA_depth, 
                        mode, item_tower, load_ckpt_name, label_screen, logging_num, save_step,
                        testing_num,weight_decay, drop_rate, batch_size, lr, embedding_dim,
                        image_resize, image_model_load, text_model_load, video_model_load, epoch,
                        text_freeze_paras_before, image_freeze_paras_before, video_freeze_paras_before, max_seq_len, frame_interval, frame_no,
