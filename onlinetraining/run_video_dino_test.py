...
# exp_name = f"{user_model_load}_{video_model_load}-baselineGatedPerceiver"
exp_name = f"{user_model_load}_{video_model_load}-resamplePerceiver"
        ...
        for max_seq_len in max_seq_len_list:
            for index in index_list:
                ...
                run_py = "CUDA_VISIBLE_DEVICES='0,1,2,3' \
                        ...
                        --nproc_per_node 4 --master_port 29500 main_dino.py \
